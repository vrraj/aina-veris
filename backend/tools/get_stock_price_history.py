...
def tool_definition() -> Dict[str, Any]:
    return {
        ...
        "function": {
            "name": TOOL_NAME,
            "description": (
                "Tool for retrieving stock price history and charts. Use this whenever a user requests a stock's "
                "performance, trend, or visual chart. It accepts a stock symbol and timeframe (e.g., 5-day, 1-month, "
                "6-month, or 1-year) and returns normalized price data plus an SVG visualization."
            ),
            "parameters": {
                "type": "object",
                "properties": {
