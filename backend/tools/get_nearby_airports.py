...
TOOL_SPEC: Dict[str, Any] = {
    ...
    "function": {
        ...
        "description": "Find nearest or closest airports to a place or coordinate. Returns up to max_results sorted by distance.",
        "parameters": {
            "type": "object",
            "properties": {
...
def _geocode(place: str) -> Optional[Tuple[float,float]]:
    ...
    try:
        r = requests.get(
            ...
            headers={"User-Agent": os.getenv("OSM_UA", "aina-veris/1.0 (contact@example.com)")},
