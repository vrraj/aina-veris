...
start:
	...
	@echo "Access the application at: http://localhost:8100"
	@echo "Qdrant and Chat application started successfully."
...
start-debug:
	...
	@. .venv/bin/activate && uvicorn backend.main:app --reload --host 0.0.0.0 --port 8100 --log-level debug
...
# Example Use: http://192.168.86.174:8100 (where the ip address is from the command below
