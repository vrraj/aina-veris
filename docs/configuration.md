...
> **About this document**
>
> This page provides a **comprehensive configuration reference** for the *Aina-Veris* system, including environment variables, model settings, and runtime parameters.
>
...
The model registry defines all available LLM providers and models for the aina-veris system. For complete model details, pricing, and capabilities, see the **[full Model Registry documentation](https://vrraj.github.io/llm-adapter/model-registry.html)**.
