---
layout: default
title: "Aina-Veris | Tool-Assisted Multi-Provider RAG Framework"
...
# Aina-Veris: Modular Tool-Assisted RAG Pipeline

<p align="left">
  <a href="https://github.com/vrraj/aina-veris">
    <img src="https://img.shields.io/github/stars/vrraj/aina-veris?style=social" alt="GitHub Stars">
  </a>
  <a href="https://github.com/vrraj/aina-veris/releases">
    <img src="https://img.shields.io/github/v/release/vrraj/aina-veris?label=github%20release&color=orange&logo=github" alt="GitHub Release">
  </a>
  <a href="https://github.com/vrraj/aina-veris/actions">
    <img src="https://img.shields.io/github/actions/workflow/status/vrraj/aina-veris/python-ci.yml?label=CI&logo=github" alt="CI Status">
  </a>
</p>
...
Aina-Veris implements a modular architecture for building **tool‑assisted Retrieval‑Augmented Generation (RAG) systems**. The framework combines:
...
[View the Code](https://github.com/vrraj/aina-veris) | [Technical Deep Dive](technical-overview.md) | [API Reference](api-reference.md)

## System Architecture Overview

<p align="center">
  <img
    src="aina-veris-architecture.png"
    style="max-width: 100%; height: auto;"
    alt="Aina-Veris architecture overview showing multi-LLM orchestration, prompt registry, context management, observability, and embeddable interfaces"
  />
</p>
...
Aina-Veris can support several AI application patterns:
...
Aina-Veris provides three primary interfaces for different use cases:
