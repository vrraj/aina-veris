...
> **About this document**
>
> This page explains the **embeddable chat UI** for the *Aina-Veris* system, including configuration options, integration methods, and usage examples for third-party websites.
>
...
<p align="center">
  <img
    src="https://github.com/vrraj/aina-veris/blob/main/images/chat-embedding-options.png?raw=true"
    style="max-width: 100%; height: auto;"
    alt="Aina-Veris embedded chat interface showing configuration options and chat widget"
  />
</p>
...
2. **Open the embed page directly**:
   ...
   ```text
   http://localhost:8100/chat-embed.html
   ```

3. **Try with custom params**:

   ```text
   http://localhost:8100/chat-embed.html?top_k=8&score_threshold=0.35&temperature=0.4
   ```
...
1. Open the page where you want to preview the widget (e.g. `http://localhost:8100/search` or `http://localhost:8100/chat.html`).
...
(function () {
  ...
  iframe.src = 'http://localhost:8100/chat-embed.html'
    + '?top_k=8'
    + '&score_threshold=0.35'
    + '&temperature=0.4'
    + '&max_output_tokens=300'
