...
> **About this document**
>
> This page covers **tested deployment scenarios** for the *Aina-Veris* system, including Docker setup, production considerations, and security best practices.
>
...
The aina-veris system consists of several components:
...
# Only expose the web application (port 8100)
```
...
# Rotate logs
logrotate -f /etc/logrotate.d/aina-veris
```
...
docker logs aina-veris_app_1
docker logs aina-veris_qdrant_1
