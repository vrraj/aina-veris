...
> **About this document**
>
> This page provides **complete API documentation** for the *Aina-Veris* system, including both stateless and session-based chat endpoints with request/response formats, parameters, and integration examples.
>
...
```bash
curl -X POST http://localhost:8100/chat/session-id \
  -H "Content-Type: application/json" \
  -d '{
